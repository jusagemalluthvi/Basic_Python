...
with open("D:\JUSA\Basic_Python\Basic_Python\Final-Project\email_penerima.txt", "r") as penerima: 
...
html = """\
            <html>
            <body>
                <p><b>Final Project Basic Python</b><br>
                Ini adalah final project dari Jusagemal.<br>
                Terima kasih.
                </p>
            </body>
            </html>
